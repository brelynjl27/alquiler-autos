...
CREATE TABLE `solicitud_credito` (
  ...
  KEY `fk_solicitud_auto` (`auto_id`),
  CONSTRAINT `fk_solicitud_auto` FOREIGN KEY (`auto_id`) REFERENCES `autos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_solicitud_cliente` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `solicitud_credito` VALUES (1,'2025-10-02',15000,'PENDIENTE',1,1),(2,'2025-10-02',18000,'APROBADO',2,2);
